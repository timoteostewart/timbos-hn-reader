...
class Story(Item):
    def __init__(
        ...
        self.og_image_dict: Dict = {}
        self.og_image_dict["og_image_url"]: str = None
        self.og_image_dict["og_image_url_possibly_redirected"]: str = None
        self.og_image_dict["og_image_content_type"]: str = None
        self.og_image_dict["normalized_og_image_filename"]: str = None
        self.og_image_dict["downloaded_orig_thumb_full_path"]: str = None
        self.og_image_dict["downloaded_og_image_magic_result"]: str = None
        self.og_image_dict["og_image_filename_details_from_url"]: str = None
        self.og_image_dict["thumb_aspect_hint"]: str = None
