...
# my_bucket = s3_resource.Bucket(secrets_file.aws_s3_bucket_name)

bucket_cdn = s3_resource.Bucket(secrets_file.aws_s3_bucket_name_cdn)
bucket_html = s3_resource.Bucket(secrets_file.aws_s3_bucket_name_html)


# def does_object_exist(full_s3_key):
#     try:
#         object = s3_resource.Object(secrets_file.aws_s3_bucket_name, full_s3_key)
...
#             secrets_file.aws_s3_bucket_name_cdn, f"{config.s3_stories_path}{story_filename}"
#         )
#         l = object.content_length
#         return l >= 0
#     except ClientError as e:
...
#     try:
#         object = s3_resource.Object(
#             secrets_file.aws_s3_bucket_name_cdn, f"{config.s3_thumbs_path}{thumb_filename}"
#         )
#         l = object.content_length
#         return l >= 0
#     except ClientError as e:
...
def get_json_from_s3_as_dict(full_s3_key):
    try:
        obj = s3_resource.Object(
            bucket_name=secrets_file.aws_s3_bucket_name_cdn, key=full_s3_key
        )
...
#     try:
#         obj = s3_resource.Object(bucket_name=secrets_file.aws_s3_bucket_name_cdn, key=full_s3_key)
